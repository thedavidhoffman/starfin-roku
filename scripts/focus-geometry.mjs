...
export const focusGeometry = [
  ...
  {
    name: "home-music-row",
    asset: "images/homepage/home-page-music-focus-345x423.png",
  ...
  },
  {
    ...
    asset: "images/homepage/home-page-thumbnail-focus-486x348.png",
    owner: "components/pages/HomePage/HomeShelf/HomeShelf.xml",
    surface: "RowList",
    canvas: [486, 348],
    image: [21, 0, 441, 249],
    outline: [3, 0, 3, 3],
    anchorCompensation: [20, 0, 21, 0],
  },
  {
    name: "home-my-media-thumbnail-row",
    asset: "images/homepage/home-page-my-media-thumbnail-focus-486x306.png",
    owner: "components/pages/HomePage/HomeShelf/HomeShelf.xml",
    surface: "RowList",
    canvas: [486, 306],
    image: [21, 0, 441, 249],
  ...
  },
  {
    ...
    asset: "images/homepage/home-page-poster-focus-297x465.png",
    owner: "components/pages/HomePage/HomeShelf/HomeShelf.xml",
    surface: "RowList",
    canvas: [297, 465],
    image: [21, 0, 252, 378],
  ...
  {
    name: "music-artist-grid",
    asset: "images/music/album-focus-360x432.png",
  ...
  {
    name: "music-album-grid",
    asset: "images/music/album-focus-360x462.png",
    owner: "components/pages/Music/MusicLibrary/MusicLibrary.xml",
    surface: "MarkupGrid",
    canvas: [360, 462],
    image: [9, 33, 342, 342],
  ...
  },
  {
    ...
    asset: "images/music/album-horizontal-focus-360x399.png",
...
export const focusSourceChecks = {
  ...
  "components/pages/Music/MusicAlbumCard/MusicAlbumCard.xml": [
    "translation=\"[9,0]\"",
    "translation=\"[0,33]\" maskUri=\"pkg:/images/masks/fhd/album-mask-342.png\" maskSize=\"[342,342]\"",
  ],
  ...
  "components/pages/Music/Artist/Artist.xml": [
    "rowItemSize=\"[[360,399]]\"",
    "focusBitmapUri=\"pkg:/images/music/album-horizontal-focus-360x399.png\"",
  ],
