...
Press * to view Episode details
Support horizontal vs vertical tv episode nav
...
# Sunday
## episode list
- left/right chevron spacing from content seems different
- highlight/focus graphic offset to the right